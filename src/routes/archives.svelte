<script context="module">
	...
	export const load = async ({ fetch }) => {
		const res = await fetch('/data/past-events.json');
...
<script>
	...
	/** @type {import('../../scripts/types.d').Announcement[]}*/
	export let events;
</script>
...
<div class="events" in:fadeIn out:fadeOut>
	<h1 class="text_center heading">Archives</h1>
	...
	{#each events as event}
		<div class="event">
			...
			<div class="club-name-div">
				<h3 class="club-name">{event.name}</h3>
			</div>
